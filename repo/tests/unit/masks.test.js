...
describe('maskDisplayName', () => {
  ...
  it('handles non-string truthy input', () => {
    expect(maskDisplayName(1234)).toBe('****')
  })

  it('handles leading and trailing whitespace tokens', () => {
    expect(maskDisplayName(' Alice  Bob ')).toBe(' A**** B*** ')
  })
